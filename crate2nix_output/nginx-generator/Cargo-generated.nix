...
#   "generate" "-f" "/home/mdupont/projects/nginx-generator/Cargo.toml" "-o" "crate2nix_output/nginx-generator/Cargo-generated.nix"
      ...
      "nginx-generator" = rec {
        ...
        crateBin = [
          ...
          }
          {
            ...
            path = "src/bin/project_scanner.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../../../../../../../../../../../../home/mdupont/projects/nginx-generator; };
        dependencies = [
          {
            name = "chrono";
            packageId = "chrono";
