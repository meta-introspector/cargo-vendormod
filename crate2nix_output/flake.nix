  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    ...
    in {
      packages = forAllSystems (system:
        ...
        in {
          agave-solana-validator = (pkgs.callPackage ./agave-solana-validator/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          boa = (pkgs.callPackage ./boa/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          cargo2 = (pkgs.callPackage ./cargo2/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          ...
          forgecode = (pkgs.callPackage ./forgecode/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          fractran-vm = (pkgs.callPackage ./fractran-vm/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          gibb-eri-sh = (pkgs.callPackage ./gibb.eri.sh/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          ...
          rust = (pkgs.callPackage ./rust/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          solfunmeme-dioxus = (pkgs.callPackage ./solfunmeme-dioxus/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          ...
          solfunmeme-dioxus2 = (pkgs.callPackage ./solfunmeme-dioxus2/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
          ...
          zos-plugins = (pkgs.callPackage ./zos-plugins/Cargo-generated.nix { inherit pkgs buildRustCrateForPkgs; }).rootCrate.build;
        }
      );
    };
}
